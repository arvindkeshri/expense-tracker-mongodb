...
const createNewPassword = async(req, res) =>{
  ...
  try{
  const createPasswordUUID = await Resetpassword.findOne({id: req.params.id})
...
const postNewPassword = async(req, res) =>{
  ...
  try{
    const row = await Resetpassword.findOne({id: id});
    ...
    const updatedPassword = Resetpassword.updateOne({active:false},{id:id})
